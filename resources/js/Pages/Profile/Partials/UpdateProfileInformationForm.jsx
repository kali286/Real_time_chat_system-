            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
                ...
                <div>
                    <InputLabel htmlFor="avatar" value="profile picture" />
                     ...
                     id="avatar"
                     type="file" 
                     className="file-input file-input-border file-input-primary w-full max-w-xs"
                     onChange={(e) => setData('avatar', e.target.files[0])}
                     />
                     <p className="mt-1 text-gray-400 dark:text-gray-400">please upload square image, Ex: 512px&times;512px</p>
